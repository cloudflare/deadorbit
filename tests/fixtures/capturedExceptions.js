...
module.exports.CHROME_41_EVAL = {
  message: 'getExceptionProps is not defined',
  name: 'ReferenceError',
  stack: 'ReferenceError: getExceptionProps is not defined\n' +
    '    at eval (eval at foo (http://path/to/file.js:12:8), <anonymous>:1:1)\n' +
    '    at foo (http://path/to/file.js:12:3)\n' +
    '    at bar (http://path/to/file.js:63:1)'
};

module.exports.CHROME_41_NATIVE = {
  message: 'Cannot read property \'call\' of undefined',
  name: 'TypeError',
  stack: 'TypeError: Cannot read property \'call\' of undefined\n' +
    '    at setConfig (http://path/to/file.js:9583:43)\n' +
    '    at Array.map (native)\n' +
    '    at bar (http://path/to/file.js:55210:56)'
};

module.exports.FIREFOX_3 = {
